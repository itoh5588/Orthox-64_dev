...
void syscall_dispatch(arch_syscall_frame_t* frame) {
    ...
    switch (syscall_no) {
        ...
        case SYS_IOCTL:
            ...
            break;
        case SYS_WRITEV:
            frame->rax = (uint64_t)sys_writev((int)frame->rdi, (const struct linux_iovec*)frame->rsi, (int)frame->rdx);
            break;
        case SYS_READV:
            frame->rax = (uint64_t)sys_readv((int)frame->rdi, (const struct linux_iovec*)frame->rsi, (int)frame->rdx);
            break;
        case SYS_PIPE:
        ...
        case SYS_RT_SIGPROCMASK:
            ...
            break;
        case SYS_NANOSLEEP:
            frame->rax = (uint64_t)sys_nanosleep((const struct linux_timespec*)frame->rdi,
                                                 (struct linux_timespec*)frame->rsi);
            break;
        case SYS_GETPID:
        ...
        case SYS_GETEGID:
            ...
            break;
        case SYS_SOCKET:
            frame->rax = (uint64_t)net_socket_socket((int)frame->rdi, (int)frame->rsi, (int)frame->rdx);
            break;
        case SYS_CONNECT:
            frame->rax = (uint64_t)net_socket_connect((int)frame->rdi, (const void*)frame->rsi, (uint32_t)frame->rdx);
            break;
        case SYS_ACCEPT:
            frame->rax = (uint64_t)net_socket_accept((int)frame->rdi, (void*)frame->rsi, (uint32_t*)frame->rdx);
            break;
        case SYS_SENDTO:
            frame->rax = (uint64_t)net_socket_sendto((int)frame->rdi, (const void*)frame->rsi, (size_t)frame->rdx,
                                              (int)frame->r10, (const void*)frame->r8, (uint32_t)frame->r9);
            break;
        case SYS_RECVFROM:
            frame->rax = (uint64_t)net_socket_recvfrom((int)frame->rdi, (void*)frame->rsi, (size_t)frame->rdx,
                                                (int)frame->r10, (void*)frame->r8, (uint32_t*)frame->r9);
            break;
        case SYS_SHUTDOWN:
            frame->rax = (uint64_t)net_socket_shutdown((int)frame->rdi, (int)frame->rsi);
            break;
        case SYS_BIND:
            frame->rax = (uint64_t)net_socket_bind((int)frame->rdi, (const void*)frame->rsi, (uint32_t)frame->rdx);
            break;
        case SYS_LISTEN:
            frame->rax = (uint64_t)net_socket_listen((int)frame->rdi, (int)frame->rsi);
            break;
        case SYS_GETSOCKNAME:
            frame->rax = (uint64_t)net_socket_getsockname((int)frame->rdi, (void*)frame->rsi, (uint32_t*)frame->rdx);
            break;
        case SYS_GETPEERNAME:
            frame->rax = (uint64_t)net_socket_getpeername((int)frame->rdi, (void*)frame->rsi, (uint32_t*)frame->rdx);
            break;
        case SYS_SETSOCKOPT:
            frame->rax = (uint64_t)net_socket_setsockopt((int)frame->rdi, (int)frame->rsi, (int)frame->rdx,
        ...
        case SYS_PSELECT6:
            frame->rax = (uint64_t)sys_pselect6((int)frame->rdi, (uint64_t*)frame->rsi,
                                                ...
                                                (const struct linux_timespec*)frame->r8,
                                                (const void*)frame->r9);
            break;
        case SYS_MKDIRAT:
        ...
        case SYS_CLOCK_GETTIME:
            frame->rax = (uint64_t)sys_clock_gettime((int)frame->rdi, (struct linux_timespec*)frame->rsi);
            break;
        case SYS_SETPGID:
